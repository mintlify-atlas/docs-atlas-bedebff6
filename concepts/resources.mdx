...
```http
GET    /api/indicators/:indicatorId/resources               # List all resources for an indicator
GET    /api/indicators/:indicatorId/resources/:resourceId   # Get a single resource
POST   /api/indicators/:indicatorId/resources               # Create a resource (admin)
PUT    /api/indicators/:indicatorId/resources/:resourceId   # Update a resource (admin)
DEL    /api/indicators/:indicatorId/resources/:resourceId   # Delete a resource (admin)
```

There is also a general resources endpoint:
