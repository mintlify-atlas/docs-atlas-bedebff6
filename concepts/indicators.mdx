...
The image export sends a JSON payload specifying the chart type, dimensions, colors, granularity, and date range. The server returns a binary PNG blob. See [Exporting chart as image](/guide/export-image) for the full request format.
